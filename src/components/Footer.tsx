...
export default function Footer() {
  return (
    <footer className="flex h-16 items-center justify-center border-y-2 border-foreground bg-background px-10 lg:justify-between lg:text-xl">
      <span className="flex items-center justify-center gap-2">
        <Image src={Logo} alt="" className="size-8 md:size-12" />
        <h1 className={`font-display text-xl md:text-3xl font-bold ${lobster.className}`}>
          BiteSized Reviews
        </h1>
      </span>
